...
(function () {
  ...
  // ---- favicon (site-wide audit 2026-08-16 flagged: 0 <link rel=icon> on any page) ----
  if (!document.querySelector('link[rel~="icon"]')) {
    var ic = document.createElement("link");
    ic.rel = "icon"; ic.href = "/favicon.ico"; ic.type = "image/x-icon";
    document.head.appendChild(ic);
    var ap = document.createElement("link");
    ap.rel = "apple-touch-icon"; ap.href = "/favicon.ico";
